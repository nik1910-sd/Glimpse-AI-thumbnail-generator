            ...
            <div class="flex pt-14">
                ...
                <main class="lg:ml-60 w-full px-6 py-6">
                    ...
                    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        <article>
                            <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1587620962725-abab7fe55159?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1633356122544-f134324a6cee?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1550439062-609e1531270e?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1633356122102-3fe601e05bd2?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                        ...
                        <article>
                            <img src="https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=600&q=80" class="rounded-xl" />
                            <div class="flex gap-3 mt-3">
                                <img src="https://i.pravatar.cc/36?9" class="rounded-full h-9 w-9" />
                                <div>
                                    <h3 class="font-semibold line-clamp-2">Electronic Beats Collection 2026</h3>
                                    <p class="text-sm text-gray-400">Vibe Radio</p>
                                    <p class="text-sm text-gray-400">500K views • 1 week ago</p>
                                </div>
                            </div>
                        </article>
                    </section>
